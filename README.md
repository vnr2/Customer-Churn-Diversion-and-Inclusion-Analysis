...
This case study deals with call center trends where we analyze the number of incoming calls, call agent's performance, Speed of answer, call duration trends on a daily and hourly basis, and customer satisfaction ratings. The dashboard defines key KPIs that impact customer satisfaction as well as the performance of the call agents. The goal is to identify the opportunity where the performance can be monitored and enhanced.
...
Case Study - 2 (Customer Retention and Risk Analysis)
![image](https://github.com/user-attachments/assets/a549b31b-0b73-4f9f-9e00-3d80dfedaae7)
![image](https://github.com/user-attachments/assets/2fd4ac0a-729e-45fe-9ba2-b95be2610b30)

Overview

Organizations need to know possible customers who are likely to churn. In this dashboard, we create KPIs around demographics. Company service and Customer profiling to know which of them has the highest chance of getting churned
